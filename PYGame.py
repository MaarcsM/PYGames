...
Musica_Load = "Assets\Audio\Background_SONG.mp3"
Musica_GameOver = "Assets\Audio\GameOver_SONG.mp3"

try:
    pygame.mixer.music.load(Musica_Load)  #Música de fundo
    musica_game_over = pygame.mixer.Sound(Musica_GameOver)  # Música de GameOver
...
Background = "Assets/Pictures/PYGame.png"
fundo = pygame.image.load(Background)
fundo = pygame.transform.smoothscale(fundo, (tela_comprimento, tela_altura))

# ------ Parâmetros | Tela Inicial ------- #
Fundo_Tela_Inicial = "Assets\Pictures\Tela.png"
tela_inicial = pygame.image.load(Fundo_Tela_Inicial)  #Aimagem de tela inicial
tela_inicial = pygame.transform.smoothscale(tela_inicial, (tela_comprimento, tela_altura))

# ------ Parâmetros | Game Over's ------- #
Tela_Game_Over = "Assets\Pictures\Tela_Game_Over.png"
game_over_surface = pygame.image.load(Tela_Game_Over)
game_over_surface = pygame.transform.smoothscale(game_over_surface, (tela_comprimento, tela_altura))

# ------ Parâmetros | Personagem ------- #
Imagem_Personagem = "Assets\Pictures\Personagem.png"
personagem_surface = pygame.image.load(Imagem_Personagem)
...
Imagem_Tubos = "Assets\Pictures\Cano_Principal.png"
fundo_tubos = pygame.image.load(Imagem_Tubos)
